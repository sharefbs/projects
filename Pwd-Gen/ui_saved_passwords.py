# Create Saved passwords page
'''
Make:
refresh button, table view,
masked passwords, reveal/hide toggle,
strength meter, backend integration
'''
...
class SavedPasswordsPage(QWidget):
    def __init__(self, backend, cipher):
        super().__init__()

        self.backend = backend      # vault backend module
        self.cipher = cipher        # encryption key
    ...
    def add_row(self, label, password):
        ...
        pwd_item.setData(Qt.UserRole, password)     # store real password
